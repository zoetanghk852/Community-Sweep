...
export const faqItems = [
  {
    question: '誰可以參加？一定要是長者嗎？',
    answer:
      '換物市集開放所有街坊參加，不設年齡門檻。計畫特別關注行動不便、有居家囤積困擾的長者，但任何人都可以帶物換物、做義工，或先試水溫參觀了解流程。首次參觀即使不帶物品，也可獲得少量歡迎積分，降低參與門檻。',
  },
  {
    question: '「社區感謝積分」是什麼？可以換現金嗎？',
    answer:
      '社區感謝積分是換物市集內流通的記帳單位，用於物品交換與獎勵參與行為（如出席、帶物、做義工）。剩餘積分可兌換低成本社區禮品（如環保袋、社區刊物），但不可兌現金、不可付費購買、不可兌換高價值或外部商品。',
  },
  {
    question: '在 App 上預約了物品，怎麼拿到實物？',
    answer:
      '線上換物僅負責瀏覽、上架與積分預約；實物一律在下次換物市集現場交收，不提供快遞寄送。預約成功後，請於市集當日到換物攤，由義工核對預約並完成交收。建議事先透過 App 報名下次市集，已報名者在維修攤、數碼義診攤排隊時可享有優先。',
  },
  {
    question: '物品怎麼定價？我可以自己標積分嗎？',
    answer:
      '不可以自行議價或標價。義工會依固定類別分值表核定積分（例如衣物 2 分、家電 4 分等）；表外物品可走例外評分，給予少量固定積分作為登記與鼓勵。物主不需自行估價，也沒有港元標價。',
  },
  {
    question: '維修攤當場修不好怎麼辦？',
    answer:
      '若維修攤當場無法修好，義工會為物品辦理留件追蹤，暫存於合作暫存點（如社區中心、教會）。待零件備妥後，於下次換物市集修繕完成，再通知物主取回。物品不會要求物主帶回家等候，也不會在未徵得同意下轉介區外維修。',
  },
] as const
