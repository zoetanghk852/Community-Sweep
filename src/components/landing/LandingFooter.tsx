  ...
  return (
    <footer className="border-t border-border-warm bg-cream-dark">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-sm">
            <div className="flex items-center gap-2.5">
              <Leaf className="h-6 w-6 text-sage-dark" weight="duotone" />
          ...
          <nav aria-label="頁尾導覽">
            <ul className="flex flex-wrap gap-x-6 gap-y-3 text-base font-medium text-ink-muted">
        ...
        <div className="mt-12 flex flex-col items-start gap-3 border-t border-border-warm pt-8 text-base text-muted sm:flex-row sm:items-center sm:justify-between">
          <p>社區換物carousell · 香港 · 規劃示範</p>
          <div className="flex gap-5">
            <Link href="/privacy" className="interactive hover:text-sage-dark">
              私隱政策（示範）
            </Link>
            <Link href="/terms" className="interactive hover:text-sage-dark">
              使用條款（示範）
            </Link>
          </div>
        </div>
