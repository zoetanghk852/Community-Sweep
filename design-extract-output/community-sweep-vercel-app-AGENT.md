# You are building UI in the community-sweep.vercel.app design system.
...
- secondary   #a85538
- accent      #f5f1ea
- neutrals    #ffffff · #5a4e3c · #000000 · #736456 · #e4ede8 · #b8a48a
...
- scale      2px · 54px · 63px · 72px · 90px · 99px · 108px · 136px · 181px · 208px · 325px

## Radii

- scale      7px · 14px · 18px · 27px · 32px
...
```bash
npx designlang community-sweep.vercel.app
```
...
Generated by designlang. Re-extract by running `npx designlang community-sweep.vercel.app`.
